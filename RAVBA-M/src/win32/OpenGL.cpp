...
//	#RA
void RenderAchievementOverlays( RECT& rc, HDC hDC )
{
	...
	//if( pSurface != NULL )
	{
		...
		//if( pSurface->GetDC( &hDC ) == S_OK )
		{
			...
			RA_UpdateRenderOverlay( hDC, &input, ((float)nDelta / 1000.0f), &rc, theApp.fullScreenStretch, theApp.paused );
