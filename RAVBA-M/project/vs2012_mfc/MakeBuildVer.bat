...
for /f "tokens=1,2 delims=-" %%a in ("%ACTIVE_TAG:~8%") do set VERSION_TAG=%%a&set VERSION_REVISION=%%b
...
@echo #define RAVBA_VERSION "%VERSION_NUM%.%VERSION_REVISION%" > BuildVer2.h
