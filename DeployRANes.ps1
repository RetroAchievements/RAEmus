Function DeployNES
{
    ...
    Process
    {
        ...
        $FilesToCopy = @(".\RA_Integration\Overlay",
                         ".\RANes\output\fcs",
                         ".\RANes\output\luaScripts",
                         ".\RANes\output\palettes",
                         ".\RANes\output\tools",
                         ".\RANes\output\7z.dll",
                         ".\RANes\output\auxlib.lua",
                         ".\RANes\output\lua5.1.dll",
                         ".\RANes\output\lua51.dll",
                         ".\RANes\output\RANes.exe",
                         ".\RANes\output\taseditor.chm");

        $TargetArchiveName = "RANes.zip"

        $VersionDoc = "..\RAWeb\LatestRANESVersion.html"
